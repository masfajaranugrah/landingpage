...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] py-40 overflow-hidden text-white antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="container mx-auto  relative  px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-[30px] md:text-xl mt-8 dark:text-neutral-200">
